...
/* ISR(TIMER1_COMPA_vect){
  ...
  PORTD |= (1 << OE);   // disable SR outputs (LEDs)
  
  /* update PWM duty values
   * [(LEDmux + LEDnum - 1) % LEDnum] shifts LED # by 1,
   * whic compensates for PWM duty not taking effect until next cycle
   */
